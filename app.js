...
// 环境变量
const UUID = process.env.UUID || '0b40bb34-dd84-4dfe-bda8-a9f5a483b1e4'; // 使用哪吒v1，在不同的平台部署需修改UUID，否则会覆盖
...
const NEZHA_KEY = process.env.NEZHA_KEY || 'KAZ6PUiUClMPXqYgTV';             // v1的NZ_CLIENT_SECRET或v0的agent端口  
